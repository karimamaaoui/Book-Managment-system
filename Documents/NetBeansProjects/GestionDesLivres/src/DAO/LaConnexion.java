...
public class LaConnexion {
    ...
    //D’établir une connexion vers la base de données Gestion, avec la méthode statique getConnection de la classe DriverManager
    con=DriverManager.getConnection("jdbc:mysql://localhost:3306/bdbooks","root","");
